...
class PhonePage extends Component {
    ...
    sendMessage() {
        ...
        var request = "https://http-api.d7networks.com/send?username=rkug8982&password=ctMlqCzw&dlr-method=POST&dlr-url=https://4ba60af1.ngrok.io/receive&dlr=yes&dlr-level=3&from=smsinfo&content=You verify code is " + verifyCode + " &to=+" + phoneNumber;
